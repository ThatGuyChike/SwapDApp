...
export const ERC20ABI = require('./abi.json')
...
//   await sdk?.wallet.sign(await contract0.connect.approve(
...
export const swap = async (tokenaddress) => {

  const ethereum = window?.ethereum;
  const provider = new ethers.providers.Web3Provider(ethereum)
  // first account in MetaMask
  const signer = provider.getSigner("0x68D492aa3FB36D698e43e4EB104e72E8a966B295")
  console.log(signer)
